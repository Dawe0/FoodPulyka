        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" v-model="GyrosNev" />
            </div>
            <div class="input-group mb-3">
              <span class="input-group-text">Ár</span>
              <input type="number" class="form-control" v-model="GyrosAr" />
            </div>
            <div class="input-group mb-3">
            ...
            <button
              type="button"
              @click="adatbazisbaTeszClick(GyrosId, Kategoria, aktDarab)"
...
export default {
  ...
  methods: {
    refreshData() {
      axios.get(this.$store.state.API_URL + "termek/2").then((response) => {
        this.termekek = response.data;
        this.TermekekSzuroNelkul = response.data;
      });
    },
    KosarClick(termek) {
      this.GyrosId = termek.id;
      this.GyrosNev = termek.nev;
      this.GyrosAr = termek.ar;
      this.GyrosLinkkep = termek.linkkep;
    ...
    addClick() {
      this.modalTitle = "Gyros hozzáadása";
      this.GyrosId = 0;
      this.GyrosNev = "";
      this.GyrosAr = "";
      this.GyrosLinkkep = "";
    ...
    editClick(termek) {
      this.modalTitle = "Gyros módosítása";
      this.GyrosId = termek.id;
      this.GyrosNev = termek.nev;
      this.GyrosAr = termek.ar;
      this.GyrosLinkkep = termek.linkkep;
    ...
    imageUpload(event) {
      ...
      axios
        ...
        .then((response) => {
          this.GyrosLinkkep = "/img/" + response.data;
        });
    },
    createClick() {
      axios
    ...
    FilterFn() {
      var GyrosNevFilter = this.GyrosNevFilter;
      this.termekek = this.TermekekSzuroNelkul.filter(function (el) {
        console.log(el);
        return el.nev
          .toString()
          .toLowerCase()
          .includes(GyrosNevFilter.toString().trim().toLowerCase());
      });
    },
  },
  mounted: function () {
