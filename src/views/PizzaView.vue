        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" v-model="PizzaNev" />
            </div>
            <div class="input-group mb-3">
              <span class="input-group-text">Ár</span>
              <input type="number" class="form-control" v-model="PizzaAr" />
            </div>
            <div class="input-group mb-3">
            ...
            <button
              type="button"
              @click="adatbazisbaTeszClick(PizzaId, Kategoria, aktDarab)"
...
export default {
  ...
  methods: {
    refreshData() {
      axios.get(this.$store.state.API_URL + "termek/5").then((response) => {
        this.termekek = response.data;
        this.TermekekSzuroNelkul = response.data;
      });
    },
    KosarClick(termek) {
      this.PizzaId = termek.id;
      this.PizzaNev = termek.nev;
      this.PizzaAr = termek.ar;
      this.PizzaLinkkep = termek.linkkep;
    ...
    addClick() {
      this.modalTitle = "Pizza hozzáadása";
      this.PizzaId = 0;
      this.PizzaNev = "";
      this.PizzaAr = "";
      this.PizzaLinkkep = "";
    ...
    editClick(termek) {
      this.modalTitle = "Pizza módosítása";
      this.PizzaId = termek.id;
      this.PizzaNev = termek.nev;
      this.PizzaAr = termek.ar;
      this.PizzaLinkkep = termek.linkkep;
    ...
    imageUpload(event) {
      ...
      axios
        ...
        .then((response) => {
          this.PizzaLinkkep = "/img/" + response.data;
        });
    },
    createClick() {
      axios
    ...
    FilterFn() {
      var PizzaNevFilter = this.PizzaNevFilter;
      this.termekek = this.TermekekSzuroNelkul.filter(function (el) {
        console.log(el);
        return el.nev
          .toString()
          .toLowerCase()
          .includes(PizzaNevFilter.toString().trim().toLowerCase());
      });
    },
  },
  mounted: function () {
