        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" v-model="ItalNev" />
            </div>
            <div class="input-group mb-3">
              <span class="input-group-text">Ár</span>
              <input type="number" class="form-control" v-model="ItalAr" />
            </div>
            <div class="input-group mb-3">
            ...
            <button
              type="button"
              @click="adatbazisbaTeszClick(ItalId, Kategoria, aktDarab)"
...
export default {
  ...
  methods: {
    refreshData() {
      axios.get(this.$store.state.API_URL + "termek/4").then((response) => {
        this.termekek = response.data;
        this.TermekekSzuroNelkul = response.data;
      });
    },
    KosarClick(termek) {
      this.ItalId = termek.id;
      this.ItalNev = termek.nev;
      this.ItalAr = termek.ar;
      this.ItalLinkkep = termek.linkkep;
    ...
    addClick() {
      this.modalTitle = "Ital hozzáadása";
      this.ItalId = 0;
      this.ItalNev = "";
      this.ItalAr = "";
      this.ItalLinkkep = "";
    ...
    editClick(termek) {
      this.modalTitle = "Ital módosítása";
      this.ItalId = termek.id;
      this.ItalNev = termek.nev;
      this.ItalAr = termek.ar;
      this.ItalLinkkep = termek.linkkep;
    ...
    imageUpload(event) {
      ...
      axios
        ...
        .then((response) => {
          this.ItalLinkkep = "/img/" + response.data;
        });
    },
    createClick() {
      axios
    ...
    FilterFn() {
      var ItalNevFilter = this.ItalNevFilter;
      this.termekek = this.TermekekSzuroNelkul.filter(function (el) {
        console.log(el);
        return el.nev
          .toString()
          .toLowerCase()
          .includes(ItalNevFilter.toString().trim().toLowerCase());
      });
    },
  },
  mounted: function () {
